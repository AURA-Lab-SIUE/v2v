...
![](../images/ch10-interview_1.jpg){fig-alt="A stylized rendering of a large field of dots with a small, evenly spaced subset highlighted."}
...
**The conversation between your prospectus and your sample.** The undergrad edition teaches sampling as a practical tradeoff: you cannot code everything, so you apply stratified sampling rules that capture the variation in your dataset. The graduate edition adds a second constraint: your sample must also be large enough to detect the effect you expect with adequate power.

Your prospectus power analysis (Chapter 6) specified a minimum *n* at your chosen effect size and power level. Chapter 10 is where that number meets the realities of your dataset. If your power analysis requires 128 coded units and your platform generates 10,000 units in your collection window, stratified sampling solves the problem. If your platform generates only 80 units, you face a constraint: the study is underpowered, and you must either change the design (longer collection window, multiple platforms, or a revised research question targeting a larger expected effect) or explicitly justify the limitation in the prospectus.
...
**Reflect.** (1) For your study, identify the minimum *n* from your Chapter 6 power analysis and the maximum *n* available from your dataset. If they conflict, document the conflict and propose one design modification that resolves it. (2) What is the ethical implication of publishing a study you know is underpowered because adequate data were unavailable? How should the limitations section handle this?
:::
:::
