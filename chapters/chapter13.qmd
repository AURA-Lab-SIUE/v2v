...
::: {.chapter-audio .content-visible unless-format="epub"}
[Listen in Dr. Leith's voice]{.audio-label}

```{=html}
<audio class="v2v-audio v2v-audio-ug" controls preload="none"><source src="../audio/ch13-ug.mp3" type="audio/mpeg">Your browser does not support audio.</audio>
<audio class="v2v-audio v2v-audio-grad" controls preload="none"><source src="../audio/ch13-grad.mp3" type="audio/mpeg">Your browser does not support audio.</audio>
```

:::


Chapter 12 ended on a number and a doubt. The number was a gap: across the sample, gaming channels averaged 29.54 characters per chat message and non-gaming channels 31.96, a difference of a little under two and a half characters. The doubt was whether that gap means anything.
...
message_length by is_gaming
  ...
  Mean, gaming         29.54 characters
  Mean, non-gaming     31.96 characters
  Difference           -2.43 characters
...
The test is named in the first line as a **Welch** two-sample t-test, and the choice of the Welch version is deliberate. The ordinary t-test assumes the two groups have the same spread, and Chapter 12 showed plainly that they do not: the non-gaming standard deviation, 54.51, is markedly larger than the gaming standard deviation of 39.69. Welch's t-test drops that assumption, which is why it is the safer default whenever two groups might vary by different amounts.
...
Lakens et al. (2018) argue that different research contexts justify different thresholds; for your own study, ask what would justify using *α* = .01 rather than .05.
:::
...
Fortnite                          8829       29.69
Pokemon: Let's Go, Pikachu!/Eevee! 7315       31.36
Hearthstone                       6242       29.97
League of Legends                 6077       26.09
```
