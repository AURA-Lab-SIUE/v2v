...
**What distinguishes a scholarly contribution.** The undergrad edition frames research methods as disciplined storytelling — you have a claim, you gather evidence, you tell the story the data supports. Graduate-level work adds a second obligation: your story must be reproducible, falsifiable, and positioned within a cumulative scholarly conversation.
...
**The four pillars of the graduate edition.** The rest of this book introduces four practices that separate graduate-level V2V work from competent undergraduate work: (1) *a priori power analysis* — committing to a sample size before data collection; (2) *pre-registration* — committing to hypotheses, measures, and analysis plan before collection; (3) *two-coder reliability* — verifying that your codebook produces consistent results regardless of who applies it; and (4) *audit trail* — keeping a version-controlled record of every transformation from raw data to published figure. These are not optional add-ons. They are entailments of a post-positivist epistemological commitment.
...
**Reflect.** (1) Which of the four contribution types does your current research question best fit? What would you need to change for it to fit more precisely? (2) Munafo et al. describe a "garden of forking paths" in which researcher degrees of freedom inflate false-positive rates. Where in the V2V workflow does this risk appear first, and how does pre-registration address it?
:::
:::
